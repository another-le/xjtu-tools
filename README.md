...
- **核心功能1**：通过可拖动的课程详情面板查看完整成绩信息；原成绩表和成绩统计均可打开详情，支持同时展开多门课程进行对照，并可快速定位已选课程在统计面板中的位置。
- **核心功能2**：计算各学期及全部所选课程的学分、平均成绩、平均绩点；支持通过齿轮自定义等级换算分数、绩点、平均方式、小数位数和及格线，并可拖动调整学期顺序、快捷跳转学校官网打印成绩单。
